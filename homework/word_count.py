...
def load_input(input_directory):
    """Funcion load_input"""
    # leer archivos de la carpeta de files/input y retornar una lista de tuplas
...
def line_preprocessing(sequence):
    ...
    sequence = [(key, value.lower()) for key, value in sequence if value]

    sequence = [(key, value.strip()) for key, value in sequence if value]
